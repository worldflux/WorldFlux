...
class Prioritized:
    def __init__(
        self, exponent=1.0, initial=1.0, zero_on_sample=False, maxfrac=0.0, branching=16, seed=0
    ):
...
class SampleTreeNode:
    ...
    def __repr__(self):
        return (
            f"SampleTreeNode(uprob={self.uprob}, " f"children={[x.uprob for x in self.children]})"
        )
