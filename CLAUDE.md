...
### Core Protocol (`src/worldflux/core/protocol.py`)
...
### State Representation (`src/worldflux/core/state.py`)
...
### Latent Spaces (`src/worldflux/core/latent_space.py`)
...
### Model Registry (`src/worldflux/core/registry.py`)
...
**DreamerV3** (`src/worldflux/models/dreamer/`):
